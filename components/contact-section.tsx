...
export default function ContactSection() {
  ...
  // Form change handler - THIS WAS MISSING
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
              ...
              <ul className="space-y-6 mb-8 flex-1">
                <li className="flex">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {showCopied ? <FiCheckCircle className="text-green-500" /> : <FiClipboard />}
                      </button>
                    </div>
                    {showCopied && (
                ...
                <li className="flex">
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-white">
                      <code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded text-blue-600 dark:text-blue-400">freelance</code> and <code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded text-green-600 dark:text-green-400">full-time</code> opportunities
                    </span>
                  </div>
                </li>
              </ul>
          ...
          >
            <div className="card p-6 h-full relative overflow-hidden">
              {/* Code-like decorative elements */}
              <div className="absolute top-2 right-6 text-gray-300 dark:text-gray-700 font-mono text-xs">{"function sendMessage() {"}</div>
              <div className="absolute bottom-2 right-6 text-gray-300 dark:text-gray-700 font-mono text-xs">{"}"}</div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    >
                      <span className="flex items-center">
                        <FiUser className="mr-2" /> <span className="font-mono">name<span className="text-red-500">*</span>:</span>
                      </span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    >
                      <span className="flex items-center">
                        <FiMail className="mr-2" /> <span className="font-mono">email<span className="text-red-500">*</span>:</span>
                      </span>
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  ...
                  >
                    <span className="flex items-center">
                      <span className="font-mono text-blue-500 dark:text-blue-400 mr-2">const</span> <span className="font-mono">subject:</span>
                    </span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  >
                    <span className="flex items-center">
                      <FiMessageSquare className="mr-2" /> <span className="font-mono">message<span className="text-red-500">*</span>:</span>
                    </span>
                  </label>
                  <div className="relative">
                    <div className="absolute top-0 left-0 p-3 font-mono text-gray-400 text-xs">/**</div>
                    <textarea
                      id="message"
                      name="message"
                      ...
                      required
                    />
                    <div className="absolute bottom-3 right-3 font-mono text-gray-400 text-xs">*/</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <span className="flex items-center">
                        <FiSend className="mr-2" /> <span className="font-mono">sendMessage()</span>
                      </span>
                    )}
                  </button>
